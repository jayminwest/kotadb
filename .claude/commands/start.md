...
## Checklist
1. **Pre-flight git hygiene**: `git fetch --all --prune`, `git pull --rebase`, confirm you are on the intended branch (`git rev-parse --abbrev-ref HEAD`), and verify a clean tree with `git status --short`.
