...
=======
3. **Review critical docs**: skim `README.md`, `CLAUDE.md`, `adws/README.md`, and any specs under `docs/specs/` to understand workflow expectations and Bun tooling; use `.claude/commands/docs/conditional_docs.md` to identify additional targeted docs.
>>>>>>> origin/main
