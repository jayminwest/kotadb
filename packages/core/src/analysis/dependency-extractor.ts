...
import type { IndexedFile } from "./import-resolver.js";
import type { Symbol as ExtractedSymbol } from "../types/symbol.js";
...
export function extractDependencies(
	...
	const fileDeps = buildFileDependencies(references, files);
